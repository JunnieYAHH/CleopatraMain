...
router.route('/admin/product/:id').get(isAuthenticatedUser, authorizeRoles('admin'),getAdminSingleProduct);
...
router.route('/productSales').get(isAuthenticatedUser, productSales)
